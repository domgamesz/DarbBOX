...
subprocess.call("alias DarbBOX='cd ~; cd things; python3 darbbox.py'", shell=True)
 ...
 *@@@@@@@@@@@@@@@@@@@@((@@@@@@@@@@@@@@%((@@@@@@@@,
  @@@@@@@@@@@@@@@@@@@@((@@@@@@@@@@@((((@@@@@@@@@% 
   ...
   MADE BY DOMINIC ANTHONY ROMEO BARRASSO
""")
def anything(str):
...
""")
        ...
        amak = input("// List all mp4 files?")
        if "y" in amak:
            subprocess.call("locate -i *.mp4", shell=True)
        amake = input("// List all jpg files?")
        if "y" in amake:
            subprocess.call("locate -i *.jpg", shell=True)
        amakee = input("// List all png files?")
        if "y" in amakee:
            subprocess.call("locate -i *.png", shell=True)
        EE = input("// media?: ")
        if ".png" in EE:
